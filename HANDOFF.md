...
1. **玩家市場**：**`market_listings`** **RLS**（對照 **`HANDOFF_DB.md`**）；master 下架權限若需請擴充 **`cancel_market_listing`** 或僅應用層呼叫 service_role。
