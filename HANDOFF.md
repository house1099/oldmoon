...
- **蝦仁豬心／蟲蟲餌／章魚餌**：雲端 **`shop_items.metadata`** 已對照 **heart／normal／octopus**（見上「最近完成」第 1 條）；若其他環境仍錯，後台該商品選對類型後儲存即可。
