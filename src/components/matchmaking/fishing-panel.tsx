...
function FishingRodStrip({
  ...
  return (
    <div className="rounded-xl bg-zinc-900/60 p-3 space-y-2">
      ...
      <div className="flex touch-manipulation gap-2 overflow-x-auto overscroll-x-contain pb-1 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        {rods.map((r) => {
